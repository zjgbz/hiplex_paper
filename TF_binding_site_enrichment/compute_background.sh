...
# Convert .bed to .cod
${cisgenome_bin}/file_bed2cod -i ${input_file} -o ${input_cod_file} 

# get matched genomic control regions
${cisgenome_bin}/refgene_getmatchedcontrol -d ../data/TF_binding_site_enrichment/refFlat_sorted.txt -dt 1 -s human -c ../data/TF_binding_site_enrichment/chrlen.txt -i $input_cod_file -o $ouput_cod_file -n 1 -l 200 -nr 1
...
${cisgenome_bin}/file_cod2bed -i $ouput_cod_file -o $ouput_bed_file
